    ...
    class Program
    {
        public static void Main()
        {
            ...
            using (SqlConnection connection = new SqlConnection(Connection))
            {
                ...
                var books1 = rep.GetBooks1(year, firm);
                Console.WriteLine("List of books:");
                foreach (Book book in books)
                {
                ...
                {
                    Console.WriteLine($"{item.Title}-{item.PublicationYear}-{item.PublisherAddress}-{item.BookstoreFirm}");
                }
            }
            Console.WriteLine("");
        }
